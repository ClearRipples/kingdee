package kingdee.k3.scm.pda.webapp.upgrade;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (Environment.getExternalStorageState().equals(android.os.Environment.MEDIA_MOUNTED)){
            ...
            if (destDir.exists()) {
                File destFile;
				try {
					destFile = new File(destDir.getPath() + "/" + URLEncoder.encode(mDownloadUrl, HTTP.UTF_8.toString()));
        ...
        mNotification.tickerText = getString(R.string.app_upgrade_download_start);
        mNotification.contentIntent = mPendingIntent;
        ...
        public void run() {
            if (Environment.getExternalStorageState().equals(android.os.Environment.MEDIA_MOUNTED)){
                ...
                if (destDir.exists() || destDir.mkdirs()) {
                    try {
						destFile = new File(destDir.getPath() + "/" + URLEncoder.encode(mDownloadUrl, HTTP.UTF_8));
